      ...
      <div className="overflow-x-auto">
        <div className="min-w-[800px]">
          ...
          <div className="flex border-b bg-white sticky top-0 z-30">
            <div className="w-[120px] sm:w-64 shrink-0 p-4 border-r bg-white sticky left-0 z-40" /> {/* User Info Header Placeholder */}
            ...
            {users.map((user) => {
              ...
              return (
                <div key={user.user_id} className="flex group hover:bg-gray-50/30 transition-colors h-24">
                  ...
                  <div className="w-[120px] sm:w-64 shrink-0 p-2 sm:p-4 flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-3 border-r bg-white sticky left-0 z-20">
                    ...
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left overflow-hidden w-full">
                      <span className="font-bold text-gray-800 text-xs sm:text-sm truncate w-full">{user.user_name}</span>
                      <span className="text-[10px] sm:text-xs text-gray-500 truncate w-full hidden sm:block">{user.main_department_name_kr || user.user_role_name}</span>
