...
import type { ICalendarCell, ICalendarType, IEvent, IUser } from '@/components/big-calendar/interfaces';
import type { TCalendarView, TVisibleHours, TWorkingHours } from '@/components/big-calendar/types';
import { calendarTypes } from '@/components/big-calendar/types';
