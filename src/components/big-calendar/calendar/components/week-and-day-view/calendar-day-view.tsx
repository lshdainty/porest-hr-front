...
import { EventBlock } from "@/components/big-calendar/calendar/components/week-and-day-view/event-block";
import { DroppableTimeBlock } from "@/components/big-calendar/calendar/components/dnd/droppable-time-block";
import { CalendarTimeline } from "@/components/big-calendar/calendar/components/week-and-day-view/calendar-time-line";
import { DayViewMultiDayEventsRow } from "@/components/big-calendar/calendar/components/week-and-day-view/day-view-multi-day-events-row";

import { cn } from "@/lib/utils";
import { groupEvents, getEventBlockStyle, isWorkingHour, getCurrentEvents, getVisibleHours } from "@/components/big-calendar/calendar/helpers";
  ...
  return (
    <div className="w-full h-full flex">
      <div className="flex flex-1 flex-col h-full">
        ...
        <ScrollArea className="flex-1" type="always" hideScrollbar>
          <div className="flex">
            {/* Hours column */}
      ...
      <div className="hidden w-64 divide-y border-l md:block">
        ...
        <div className="flex-1 space-y-3">
          ...
          {currentEvents.length > 0 && (
            <ScrollArea className="h-[422px] px-4" type="always" hideScrollbar>
