...
import { EventDetailsDialog } from '@/components/big-calendar/calendar/components/dialogs/event-details-dialog';
import { DraggableEvent } from '@/components/big-calendar/calendar/components/dnd/draggable-event';
