...
import { EmptyWorkDivision } from '@/features/admin-work-code/ui/EmptyWorkDivision';
import { WorkCodeResp, useWorkDivisionLabelsQuery, useWorkDivisionQuery } from '@/entities/work'
